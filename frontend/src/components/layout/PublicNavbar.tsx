      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <Link to="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-blue-700 rounded text-white flex items-center justify-center">
              <Plus className="w-6 h-6 stroke-[3]" />
            </div>
            <span className="text-2xl font-bold text-blue-700 tracking-tight">Quad Solutions</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link to="/login" className="px-5 py-2 text-sm font-semibold text-blue-700 border-2 border-blue-700 rounded-lg hover:bg-blue-50 transition-colors">
              Login
            </Link>
            <Link to="/register" className="px-5 py-2 text-sm font-semibold text-white bg-blue-700 rounded-lg hover:bg-blue-800 shadow-sm transition-colors">
              Get Started
            </Link>
          </div>
        ...
        <div className="md:hidden border-t border-slate-200 bg-white shadow-lg overflow-hidden">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col gap-3">
               <Link to="/login" onClick={() => setMobileMenuOpen(false)} className="w-full text-center block px-4 py-2 text-base font-medium text-blue-700 border border-blue-700 rounded-md">Login</Link>
               <Link to="/register" onClick={() => setMobileMenuOpen(false)} className="w-full text-center block px-4 py-2 text-base font-medium text-white bg-blue-700 rounded-md">Get Started</Link>
            </div>
          </div>
        </div>
      )}
